...
osgi::core::Workflow::Workflow(QObject* parent) 
 : Superclass(parent)
...
void osgi::core::Workflow::goBackward(const QString& desiredBranchId)
{
	...
	d->StateMachine->postEvent( new WorkflowInterstepTransitionEvent(WorkflowInterstepTransition::TransitionToPreviousStep, branchId));
}
