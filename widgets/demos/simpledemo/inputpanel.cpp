    ...
    : gics::Panel(parent)
{
    ...
    gics::Button* play = new gics::Button;
    ...
    play->setButtonType(gics::Button::monostable);
    play->setMinimumSize(60, 60);
    ...
    // Create the timeline
    m_timeline = new QTimeLine(4000, this);
    ...
    instrumentsLayout->setStretchFactor(m_slider, 1);
    instrumentsLayout->setStretchFactor(fieldLayout, 0);
